          ...
          <div className="h-full w-full flex justify-between ">
            ...
            <div className="w-[60%] h-[200%] items-center justify-center  hidden xl:flex">
              <ul className="flex gap-5">
                <a
                  href="#section1"
                  className="text-blac relative no-underline text-[20px] font-semibold underline-hover  duration-300"
                >
            ...
            <AnimatePresence>
              {mobileOpen && (
                ...
                >
                  ...
                  <a
                    href="#dansurs"
                    className="text-black no-underline text-[20px] font-semibold"
                  >
                    <p className=" cursor-pointer">심각성</p>
                  </a>
