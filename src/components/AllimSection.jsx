...
export default function AllimSection() {
    ...
    return (
        <div id="section2" className="w-full h-2/3 pb-16 relative flex justify-center bg-[#E6F3FE] items-center pt-16">
            {/* 공간 총괄 */}
            <div
                id="container"
            ...
            >
                ...
                <div className="md:w-1/2 w-full h-1/2 flex flex-col p-8 gap-3 items-center justify-center lg:ml-[10%] md:items-start ">
                    ...
                    <div>
                        ...
                        <h3 id="h31" className="xl:text-[45px] w-[510px] xl:text-4xl text-3xl font-bold">
                            급식 관리를 시작해 보세요!
                        </h3>
                    </div>
                        ...
                        <div className="fixed top-0 left-0 w-full h-full flex justify-center items-center bg-black bg-opacity-50 z-10">
                            <div className="bg-white rounded-lg w-[400px] h-[400px] relative">
                                <div className="w-full h-12 flex justify-center items-center rounded-t-md bg-blue-400">
                                    <p className="text-white font-bold mt-3">입력하신 정보가 맞나요?</p>
                                </div>
                                ...
                                <div className="w-full h-full flex flex-col justify-around">
                                    <div className="p-4 flex flex-col">
                                        <p className="text-lg">알레르기: {userData?.user.allergies}</p>
                                        <p className="text-lg">
                                            학교정보: {userData?.user.schoolNM && userData?.user.schoolNM.split(',')[0]}
                                        </p>{' '}
                                    ...
                                    <div className="text-gray-500 my-8 p-4 flex flex-col gap-3">
                                        ...
                                        <div className="w-full flex gap-2">
                                            ...
                                            {userSub.subscribe === true ? (
                                                <button class="w-1/2 btn btn-primary btn-jelly" onClick={closeModal}>
                                                    닫기
                                                </button>
                                            ) : (
