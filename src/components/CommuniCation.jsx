        ...
        <div id="section1" className={`w-full h-full flex justify-center p-8 mb-12 `}>
            ...
            <div id="container" className="w-full h-screen max-w-[1300px] flex flex-col justify-center items-center">
                ...
                <div className="mt-[4%] text-center mb-[6%]">
                    <h2 className="font-bold xl:text-[48px] text-[#333C47]">학교와 가정의 커뮤니케이션을 위한</h2>
                    <h2 className="font-bold xl:text-[48px] xl:mt-2 text-[#333C47]">최적의 솔루션, 케어키즈!</h2>
                </div>
                {/* 아래 그리드 */}
                <div className="w-full h-full max-w-[1100px]  flex flex-col justify-center items-center gap-4">
                    {/* 위쪽 그리드 */}
                    <div id="left_grid1" className="flex  md:flex-row flex-col w-full h-1/2 items-center gap-4 ">
                        {/* 왼쪽 */}
                        <div
                        ...
                        >
                            <h3 className="xl:text-[30px] md:text-[25px] text-[20px]  font-semibold">누구나</h3>
                        ...
                        >
                            <div className="w-full md:h-full h-[200px] relative bg-[#FFF8D6] rounded-2xl md:p-14 p-6">
                                <h3 className="xl:text-[30px] md:text-[25px] text-[20px] font-semibold">PC,모바일</h3>
                                <h3 className="xl:text-[30px] md:text-[25px] text-[20px] font-semibold">
                                    어디서든 간편하게
                                </h3>
                                <span className=" md:inline-block text-[13px] xl:text-[18px] text-gray-500">
                    ...
                    {/* 아래쪽 그리드 */}
                    <div id="left_grid2" className={`flex  md:flex-row flex-col w-full h-1/2 items-center gap-4 `}>
                        <div
