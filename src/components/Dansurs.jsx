            ...
            <div id="container" className="w-full max-w-[1300px] h-full">
                ...
                <div className="w-full h-[77%] flex flex-col md:flex-row justify-center items-center md:gap-4 gap-5">
                                ...
                                >
                                    <div className=" absolute bottom-0 cursor-pointer duration-300 group-hover:h-4/6 w-full h-3/5 bg-white p-2 rounded-b-xl ">
                                        ...
                                        <p className="text-[14px] text-gray-500">
                                            만성질환인만큼 꾸준한 치료가 필요한 소아 알레르기에 대해 알아볼까요?
                                        </p>
                                    </div>
                                </Link>
                            </div>
                            ...
                            <div className="w-[80%] relative  h-full ">
                                ...
                                >
                                    <div className=" absolute bottom-0 cursor-pointer duration-300 group-hover:h-4/6 w-full h-3/5 bg-white p-2 rounded-b-xl ">
                                        ...
                                        <p className="text-[14px] text-gray-500">
                                            골치아픈 식품 알레르기! 필수로 알아야 할 7가지에 대해서 알아볼까요?
                                        </p>
                                    </div>
                                </Link>
                            </div>
                    ...
                    <div className="xl:w-1/3 md:w-1/2 w-[70%] h-[100%] xl:border-x border-gray-300 flex flex-col items-center gap-4 ">
                        {/* 위쪽 기사 */}
                        <div className="w-full  xl:h-[50%] md:h-1/2 h-full flex flex-col justify-center items-center group cursor-pointer ">
                            {/* 제일 큰 틀 */}
                            <div className="w-[80%] relative border-t-4 border-black h-full ">
                                ...
                                >
                                    <div className=" absolute bottom-0 cursor-pointer duration-300 group-hover:h-4/6 w-full h-3/5 bg-white p-2 rounded-b-xl ">
                                        ...
                                        <p className="text-[14px] text-gray-500">
                                            중증 식품 알레르기는 10세 미만 영유아에게서 가장 많이 발생하는데, 정작
                                            어린이집은 알레르기 관리 대상에서 빠져 있습니다··
                                        </p>
                                    </div>
                                </Link>
                            </div>
                            ...
                            <div className="w-[80%] relative border-t-4 border-black h-full ">
                                ...
                                >
                                    <div className=" absolute bottom-0 cursor-pointer duration-300 group-hover:h-4/6 w-full h-3/5 bg-white p-2 rounded-b-xl   ">
                                        ...
                                        <p className="text-[14px] text-gray-500">
                                            식품 알레르기가 있는 아이들은 원인 물질을 먹게 되면 자칫 생명까지 위협받을
                                            수 있는데요. 이런 자녀를 둔 부모들은 아이가 밖에서 무엇을 먹게 될지 몰라
                                            전전 긍긍해야 합니다.
                                        </p>
                                    </div>
                                </Link>
                            ...
                            <div className="w-[80%] relative  h-full ">
                                ...
                                >
                                    <div className=" absolute bottom-0 cursor-pointer duration-300 group-hover:h-4/6 w-full h-3/5 bg-white p-2 rounded-b-xl ">
                                        ...
                                        <p className="text-[14px] text-gray-500">
                                            알레르기 유발물질을 포함한 제품은 별도로 해당 재료를 표시하게 돼 있다.
                                            식품알레르기가 있는 소비자라면 이를 꼭 확인 후 제품을 구입하는 것이 좋다
                                        </p>
                                    </div>
                                </Link>
                            </div>
