            ...
            >
                ...
                <div className="w-full h-full">
                    ...
                    <div id="step1" className=" w-full h-1/2 flex flex-col gap-4">
                        ...
                        {/* 오른쪽 텍스트 */}
                        <div className="">
                            <div className={`flex flex-col md:items-start ${isVisible ? 'fade-in' : ''}`}>
                                <h3 className=" md:text-4xl text-3xl font-bold ">회원가입을 클릭후</h3>
                                <h3 className=" md:text-4xl text-3xl font-bold ">정보를 입력하고 신청해주세요!</h3>
                            </div>
                        </div>
                        {/* 아래쪽 그림 */}
                    ...
                    <div id="step2" className=" w-full h-1/2 flex flex-col gap-4 mt-48">
                        ...
                        {/* 오른쪽 텍스트 */}
                        <div className="">
                            <div className={`flex flex-col  md:items-start ${isbottomVisible ? 'fade-in' : ''}`}>
                                <h3 className=" md:text-4xl text-3xl font-bold ">마이페이지에서 언제든지</h3>
                                <h3 className=" md:text-4xl text-3xl font-bold ">정보 수정이 가능합니다</h3>
                            </div>
                        </div>
                        {/* 아래쪽 그림 */}
                        <div className="w-full h-auto lg:h-[400px]  flex justify-center items-center md:h-[600px]">
