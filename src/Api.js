...
export async function apiPostProfileEdit({ file, userid }) {
    try {
        console.log('ok');
        console.log(file);
...
//구독 해제 및 신청 (추가 예정)
export async function apiPostUserSub(subState, user) {
    const subData = { subState, user };
