                    ...
                    <div className="w-full h-full flex justify-center">
                        ...
                        {selectedMenu === 'allergy' && (
                            <form
                                ...
                                className="md:w-2/3 max-w-[1000px] w-full xl:h-[40%] h-[80%] mt-16 flex flex-col items-center justify-between bg-white border rounded-xl p-4"
                            >
                                ...
                                <button className="w-1/2 mt-4 bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-6 rounded">
                                    선택하기
                                </button>
                            </form>
                        )}
