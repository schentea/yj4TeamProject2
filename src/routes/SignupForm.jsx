...
export default function SignupForm() {
  ...
  const onValid = (data) => {
    if (Object.values(isChecked).includes(true) && Object.values(isAllergyChecked).includes(true)) {
    ...
    <div id="form" className="w-full h-screen flex justify-center items-center p-4">
      ...
      >
        ...
        <form className="md:w-1/2 w-full h-full px-10  flex flex-col gap-3 items-center " onSubmit={handleSubmit(onValid)}>
          ...
          />
          {errors && <span className="text-red-500 text-sm">{errors?.userid?.message}</span>}
          <input
            className="w-full h-[50px] text-[14px] placeholder-up rounded-md px-2 py-2 outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent duration-500"
            type="text"
            placeholder="이름"
          ...
          />
          {errors && <span className="text-red-500 text-sm">{errors?.password2?.message}</span>}
          <input
            className="w-full h-[50px] text-[14px] placeholder-up rounded-md px-2 py-2 outline-none focus:ring-2 focus:ring-blue-600 focus:border-transparent duration-500"
            type="text"
            placeholder="전화번호"
