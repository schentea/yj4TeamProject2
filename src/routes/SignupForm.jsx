  ...
  return (
    <div id="form" className="w-full h-screen flex justify-center items-center">
      ...
      >
        ...
        {/* 오른쪽 로그인 박스 */}
        <div className="w-1/2 h-full  flex flex-col gap-3 items-center ">
          ...
          <input
            ...
            placeholder="학교명"
          />
          <div className="w-[250px] h-[40px] flex justify-center items-center rounded-md border-2 border-gray-800  font-semibold cursor-pointer text-black bg-slate-200 ">
            회원가입
          </div>
          <img
